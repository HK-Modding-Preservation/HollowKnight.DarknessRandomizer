    ...
    internal class LogicOverrides
    {
        ...
        public LogicOverrides()
        {
            ...
            logicOverridesByName = new()
            {
                ...
                { "Defeated_Colloseum_1", CustomSceneLogicEdit(SceneName.EdgeColo1Arena, "DARKROOMS + DIFFICULTSKIPS + PROFICIENTCOMBAT") },
                { "Defeated_Colloseum_2", CustomSceneLogicEdit(SceneName.EdgeColo2Arena, "FALSE") },
                { "Defeated_Colloseum_3", CustomSceneLogicEdit(SceneName.EdgeColo3Arena, "FALSE") },
