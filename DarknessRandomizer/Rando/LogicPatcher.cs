    ...
    internal class LogicOverrides
    {
        ...
        public LogicOverrides(LogicManagerBuilder lmb)
        {
            ...
            logicOverridesByName = new()
            {
                ...
                { WaypointNames.DefeatedElderHu, CustomDarkLogicEdit("FALSE") },
                { WaypointNames.DefeatedGalien, CustomDarkLogicEdit("FALSE") },
                { WaypointNames.DefeatedGorb, CustomDarkLogicEdit("FALSE") },
                { WaypointNames.DefeatedMarkoth, CustomDarkLogicEdit("FALSE") },
                { WaypointNames.DefeatedMarmu, CustomDarkLogicEdit("FALSE") },
                { WaypointNames.DefeatedNoEyes, CustomDarkLogicEdit("FALSE") },
                { WaypointNames.DefeatedXero, CustomDarkLogicEdit("FALSE") },
                ...
                { WaypointNames.DefeatedFailedChampion, CustomSceneLogicEdit(SceneName.DreamFailedChampion, "FALSE") },
                { WaypointNames.DefeatedGreyPrinceZote, CustomSceneLogicEdit(SceneName.DreamGreyPrinceZote, "FALSE") },
                { WaypointNames.DefeatedLostKin, CustomSceneLogicEdit(SceneName.DreamLostKin, "DARKROOMS + DIFFICULTSKIPS + PROFICIENTCOMBAT") },
                ...
                { WaypointNames.DefeatedBrokenVessel, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedBroodingMawlek, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedCollector, CustomDarkLogicEdit("DARKROOMS + DIFFICULTSKIPS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedColosseum1, CustomSceneLogicEdit(SceneName.EdgeColo1Arena, "DARKROOMS + DIFFICULTSKIPS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedColosseum2, CustomSceneLogicEdit(SceneName.EdgeColo2Arena, "FALSE") },
                { "Defeated_Colosseum_3", CustomSceneLogicEdit(SceneName.EdgeColo3Arena, "FALSE") },
                { WaypointNames.DefeatedCrystalGuardian, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedEnragedGuardian, CustomDarkLogicEdit("DARKROOMS + DIFFICULTSKIPS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedFlukemarm, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedHiveKnight, CustomDarkLogicEdit("DARKROOMS + DIFFICULTSKIPS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedHornet2, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedGrimm, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedMantisLords, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedNosk, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedPaleLurker, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedSoulMaster, CustomDarkLogicEdit("DARKROOMS + PROFICIENTCOMBAT") },
                { WaypointNames.DefeatedTraitorLord, CustomDarkLogicEdit("DARKROOMS + DIFFICULTSKIPS + PROFICIENTCOMBAT") },
